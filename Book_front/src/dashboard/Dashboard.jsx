...
const Dashboard = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-blue-100 w-full">
      <section className="p-6 my-6 md:p-40 bg-white rounded-3xl shadow-2xl">
        <div className="container grid grid-cols-1 gap-6 mx-auto md:grid-cols-2 xl:grid-cols-3">
          
          {/* Card */}
          <div className="flex overflow-hidden rounded-lg shadow-lg bg-gray-50 text-gray-800">
            <div className="flex items-center justify-center px-6 bg-violet-600 text-gray-100">
          ...
          <div className="flex items-center justify-center px-6 bg-violet-600 text-gray-100">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="w-6 h-6">
                <path d="M256 512c141.385 0 256-114.615 256-256S397.385 0 256 0 0 114.615 0 256s114.615 256 256 256zM184.118 208.705a17.971 17.971 0 1 1 35.941-2.706 17.971 17.971 0 1 1-35.941 2.706zm109.471 73.884c-24.559 12.021-52.415 12.021-76.973 0-10.735-5.249-24.671 3.084-24.671 14.765 0 3.831 1.568 7.459 4.314 10.204C215.006 329.141 235.217 336 256 336c20.783 0 40.994-6.859 58.741-19.442 2.746-2.745 4.314-6.373 4.314-10.204 0-11.681-13.936-20.015-24.671-14.765zm32.353-71.178a17.971 17.971 0 1 1 35.942 2.706 17.971 17.971 0 1 1-35.942-2.706z"/>
              </svg>
